...
function Navbar(props: any) {
  ...
  return (
    <Menu stackable>
      <Container>
        <Menu.Item header>Product Management UI</Menu.Item>
        <Menu.Item as={NavLink} exact to="/home">Home</Menu.Item>
        <Dropdown item text='Admin' style={getAdminMenuStyle()}>
          <Dropdown.Menu>
            <Dropdown.Item as={NavLink} exact to="/products" onClick={checkAuthenticated}>Products</Dropdown.Item>
            <Dropdown.Item as={NavLink} exact to="/create-product" onClick={checkAuthenticated}>Create Product</Dropdown.Item>
          </Dropdown.Menu>
        </Dropdown>
